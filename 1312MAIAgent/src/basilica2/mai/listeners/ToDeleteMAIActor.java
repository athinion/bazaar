...
public class ToDeleteMAIActor extends BasilicaAdapter
{
	...
	PromptTable maiPromptsEn;
	PromptTable maiPromptsFin;
	...
	public ToDeleteMAIActor(Agent a)
	{
		super(a, SOURCE_NAME);
		...
		try
		{
			...
			S//tring stopwordsPath = getProperties().getProperty("stopwords_file", "stopwords.txt");
				...
				pete.addCallback(new Callback()
				{
					...
					public void accepted(PriorityEvent p)
					{
						...
						new Timer(agreementWindow, new TimeoutAdapter()
						{
							...
							{
								ToDeleteMAIActor.this.log(Logger.LOG_NORMAL,"checking for agreement");
								...
								{
									ToDeleteMAIActor.this.log(Logger.LOG_NORMAL,"sending check...");
...
//	}
	...
	public static void test(ToDeleteMAIActor revoicer, String file, int verbosity)
	{
	...
	{
		ToDeleteMAIActor revoicer = new ToDeleteMAIActor(null);
		...
		while(scan.hasNext())
		{
			...
			{
				revoicer =  new ToDeleteMAIActor(null);
